...
interface Pillar { tag: string; title: string; body: string; tech: Tech[] }
...
export const ui: Record<Lang, Dict> = {
  en: {
    ...
    home: {
      ...
      pillars: [
        { tag: 'Platform & Cloud-Native', title: 'Infrastructure behind a nation', body: 'I design and run the Kubernetes platform under slovensko.sk — Slovakia’s national e-government. Automated OpenShift provisioning on Oracle PCA and bare-metal, a 40+ component GitOps stack on ArgoCD, supply-chain-secured CI/CD, and real network engineering across F5, Fortinet and Cilium.', tech: [
        ...
        { tag: 'Applied AI / ML', title: 'From MRI to vector graphics', body: 'Master’s thesis on 3D deep learning for subcortical brain MRI segmentation, benchmarked against clinical tooling. Today I’m building Logram.ai and fine-tuning OmniSVG for AI-native vector generation.', tech: [
          { name: 'Python', icon: 'logos:python' },
  ...
  sk: {
    ...
    home: {
      ...
      pillars: [
        { tag: 'Platforma & Cloud-Native', title: 'Infraštruktúra pod štátom', body: 'Navrhujem a prevádzkujem Kubernetes platformu pod slovensko.sk — portálom slovenského e-Governmentu. Automatizované nasadzovanie OpenShiftu na Oracle PCA aj holé železo, GitOps stack so 40+ komponentmi nad ArgoCD, CI/CD so zabezpečeným dodávateľským reťazcom a reálny network engineering naprieč F5, Fortinet a Cilium.', tech: [
          { name: 'Kubernetes', icon: 'logos:kubernetes' },
          { name: 'OpenShift', icon: 'simple-icons:redhatopenshift' },
          { name: 'Helm', icon: 'logos:helm' },
          { name: 'Terraform', icon: 'logos:terraform-icon' },
        ...
        { tag: 'Produkt & Architektúra', title: 'Od nápadu po škálu', body: 'Sedem rokov architektúry a spoluvedenia LiveAgentu (helpdesk SaaS vo veľkom), spoluzakladateľ a technický líder Lapz. Produkty beriem od prázdneho repozitára k fungujúcej realite — a jeden som roky rozvíjal ďalej — naprieč dátovým modelom, backendom, frontendom, mobilom aj infraštruktúrou pod tým.', tech: [
          { name: 'Go', icon: 'logos:go' },
          { name: 'TypeScript', icon: 'logos:typescript-icon' },
          { name: 'JavaScript', icon: 'logos:javascript' },
          { name: 'Python', icon: 'logos:python' },
        ...
        { tag: 'Aplikovaná AI / ML', title: 'Od MRI po vektorovú grafiku', body: 'Diplomová práca o 3D hlbokom učení na segmentáciu subkortikálnych štruktúr mozgu z MRI, porovnaná s klinickými nástrojmi. Dnes budujem Logram.ai a fine-tunujem OmniSVG na AI generovanie vektorovej grafiky.', tech: [
          { name: 'Python', icon: 'logos:python' },
          { name: 'PyTorch', icon: 'logos:pytorch-icon' },
          { name: 'Hugging Face', icon: 'logos:hugging-face-icon' },
          { name: 'OpenAI', icon: 'logos:openai-icon' },
